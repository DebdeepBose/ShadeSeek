  ...
  return (
    <div className="h-full w-full bg-black pt-4 flex justify-center ">
      <div className="relative bg-black md:px-12 text-white max-w-8xl mx-auto px-[4%] lg:px-[12%] py-8 sm:py-12 lg:py-20 w-[98%]">
        ...
        {/* Blog Preview Cards (optional placeholder) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 rounded-2xl bg-gradient-to-b from-gray-900 to-gray-800 shadow-lg">
            ...
            <Link to="/blogs/first-time-buyers" className="text-sky-400 font-semibold hover:underline">
              Read More
            </Link>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-b from-gray-900 to-gray-800 shadow-lg">
            ...
            <Link to="/blogs/rental-hacks" className="text-sky-400 font-semibold hover:underline">
              Read More
            </Link>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-b from-gray-900 to-gray-800 shadow-lg">
            ...
            <Link to="/blogs/luxury-living" className="text-sky-400 font-semibold hover:underline">
              Read More
            </Link>
          </div>
        </div>
