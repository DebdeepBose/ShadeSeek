...
export function LogOut({ onLogOutClick }) {
  return (
    <Link to="/">
      <button
        onClick={onLogOutClick}
        className="rounded-full px-6 py-3 border-r-pink-500 border-r-2 hover:scale-105 active:scale-95 transition-all duration-200 border-l-sky-500 border-l-2"
      >
