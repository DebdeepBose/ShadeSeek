  ...
  const [properties, setProperties] = useState([
    {
      ...
      description:
        "Explore 1,2 BHK apartments in Calangute, now available in Harbour Heights. Harbour Heights is a RERA- registered society with an amazing Beach Front view.",
      price: 20800000,
      date: "21-06-2024",
      image: "/Bh1.jpg",
      sqft: 1203,
    ...
    },
    {
      ...
      sqft: 5057,
      status: "Under Cons.",
      secLine: `₹${(60000000 / 5057).toFixed(0)} / sqft`,
...

    {
      ...
      sqft: 7000,
      status: "Resale",
      secLine: `₹${(60000000 / 7000).toFixed(0)} / sqft`,
